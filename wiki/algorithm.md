...
The output data created in the previous step is stored in the **data_output** directory of this project. Additional files are created which contain information about the conversion process.
